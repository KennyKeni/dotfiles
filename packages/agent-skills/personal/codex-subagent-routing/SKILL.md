...
earlier hard stops; in particular, a material contradiction immediately stops
a routine Grok scout for escalation.
...
approaches and required acceptance checks. Lane eligibility and escalation
triggers are earlier hard stops, including a Grok lane's two-unsuccessful-
approach and failed-proof boundaries.
